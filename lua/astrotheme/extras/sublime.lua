...
<dict>
	<key>author</key>
	<string>AstroNvim (http://github.com/AstroNvim)</string>
	<key>colorSpaceName</key>
	<string>sRGB</string>
	<key>name</key>
	<string>${_style_name}</string>
	<key>semanticClass</key>
	<string>enki.theme.${_style}</string>
	<key>settings</key>
	<array>
		<dict>
			<key>settings</key>
			<dict>
				<key>activeGuide</key>
				<string>${ui.text_active}</string>
				<key>background</key>
				<string>${ui.base}</string>
				<key>caret</key>
				<string>${ui.accent}</string>
				<key>findHighlight</key>
				<string>${ui.purple}</string>
				<key>findHighlightForeground</key>
				<string>${ui.base}</string>
				<key>foreground</key>
				<string>${syntax.text}</string>
				<key>guide</key>
				<string>${ui.text}40</string>
				<key>gutterForeground</key>
				<string>${ui.none_text}</string>
				<key>inactiveSelection</key>
				<string>${ui.highlight}</string>
				<key>invisibles</key>
				<string>${ui.text}</string>
				<key>lineHighlight</key>
				<string>${ui.highlight}</string>
				<key>selection</key>
				<string>${ui.selection}</string>
				<key>selectionBorder</key>
				<string>${ui.selection}</string>
				<key>shadow</key>
				<string>${ui.statusline}</string>
				<key>stackGuide</key>
				<string>${ui.text}60</string>
				<key>tagsOptions</key>
